...
public class TaiKhoanFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ivAvatar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Toast.makeText(getContext(), "Chỉnh sửa Avatar hiện chưa cập nhật!", Toast.LENGTH_SHORT).show();
            }
        });
        ivChinhSua.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if(tvTenTaiKhoan.getText()=="Tài khoản: Khách hàng"){
    ...
    public void onResume() {
        ...
        String tenTaiKhoan = sharedPreferences.getString("user","Khách hàng");
        tvTenTaiKhoan.setText("Tài khoản: "+tenTaiKhoan);
    }
